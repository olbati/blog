...
add_action('admin_menu', 'business_setup_menu');
    ...
    function business_setup_menu(){
 	...
 	function business_init(){
		...
		printf(__('Thank you for using ModernThemes!', 'business' ));
        echo "</h1></div></div>";
		...
		printf(__('Want to Give Back?', 'business' )); 
        echo "</h2>"; 
		
		echo '<p>';
		printf(__('Please help support our mission and continued development of free themes with a donation of $5, $10, $20, or more!', 'business' ));
		echo "</p>";
		...
		printf(__('Documentation', 'business' ));
        echo "</h2>";  
		...
		printf(__('Read Docs', 'business' ));
		echo "</button></a></div>";
		
		echo '<div class="col-1-3"><h2>'; 
		printf(__('About ModernThemes', 'business' ));
        echo "</h2>";  
